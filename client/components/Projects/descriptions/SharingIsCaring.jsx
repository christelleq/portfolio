  ...
  return (
    <section className="w-[95%] sm:w-[60%] lg:w-[42%]">
      ...
      <ul className="list-disc text-left text-gray-900 pl-4 pb-1">
        ...
        <li>
          Implemented solo the random reviews feature using an external API, and
          the humorous delete button
        </li>
        <li>
          Provided technical support to team members, including unblocking an
          issue with using Redux in React components
        </li>
      </ul>
      <a
